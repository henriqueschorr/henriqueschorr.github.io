Abaixo você encontra uma lista de ações possíveis ao usar a competência de Ciência, assim com tempo necessário para realizá-las, número de tentativas máximas e resultados em caso de falhar.
