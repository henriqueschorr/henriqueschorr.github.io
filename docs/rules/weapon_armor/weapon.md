Armamentos são qualquer coisa que seu personagem pode usar como meio para atacar ou se defender de inimigos. Neste capítulo você encontra informações gerais que você pode encontrar nos armamentos.
